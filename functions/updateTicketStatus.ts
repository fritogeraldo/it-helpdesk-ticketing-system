...
async function sendStatusUpdateEmail(accessToken: string, ticket: any, appUrl: string) {
  ...
  const [bgColor, textColor] = (statusColors[ticket.status] || '#f1f5f9|#475569').split('|');
        ...
        <div style="background: #f8fafc; padding: 30px; border-radius: 0 0 8px 8px; border: 1px solid #e2e8f0;">
          ...
          <div style="background: white; border: 1px solid #e2e8f0; border-radius: 8px; padding: 20px; margin: 20px 0;">
            <table style="width: 100%; border-collapse: collapse;">
              ...
              <tr><td style="padding: 8px 0; color: #64748b;">New Status:</td><td style="padding: 8px 0;"><span style="background: ${bgColor}; color: ${textColor}; padding: 2px 8px; border-radius: 4px; font-size: 14px;">${ticket.status}</span></td></tr>
            </table>
          </div>
          
          <p style="color: #475569;">Track your ticket progress anytime:</p>
